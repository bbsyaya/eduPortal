...
app.controller('msgController', function ($rootScope, $scope, $http) {
    ...
    $scope.postMsg = function () {
        ...
        var target = document.getElementById('bodyContainer');
...
app.controller('teacherController', function ($rootScope, $scope, $http) {
    ...
    //教师列表
    $http.get('http://adminapp.online-openday.com/f/edu/teacher').
        success(function (data, status, headers, config) {
    ...
    //专业列表
    $http.get('http://adminapp.online-openday.com/f/edu/teacher/majorList').
        success(function (data, status, headers, config) {
            $scope.majors = data;
            var c = "";
